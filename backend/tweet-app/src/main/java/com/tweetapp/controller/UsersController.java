...
public class UsersController {
    ...
    @PatchMapping(value = "{username}/forgot")
    public ResponseEntity<User> changeForgottenPassword(@PathVariable String username,
            @RequestBody SimpleRequest request) throws NotFoundException {
        log.info("Recieved request for password change.");
        usersService.changeForgottenPassword(username, request.getValue());
