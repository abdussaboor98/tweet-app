...
public class UsersServiceImpl implements UsersService, UserDetailsService {
    ...
    public User changeForgottenPassword(String username, String newPassword) throws NotFoundException {
        User user = new User();
        UserEntity userEntity = usersRepo.findByUsername(username).orElseThrow(() -> new NotFoundException(NotFoundException.USER_NOT_FOUND));
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        UserEntity userEntity = usersRepo.findByUsername(username).orElseThrow(() ->  new UsernameNotFoundException("The username '" + username + "' is not found."));
